...
export const metadata: Metadata = {
  title: "SwipeCart — Find Your Next Board Game in 60 Seconds",
  description:
  ...
  alternates: { canonical: "https://swipecart-app.netlify.app" },
  openGraph: {
    title: "SwipeCart — Find Your Next Board Game in 60 Seconds",
          ...
          __html: JSON.stringify([
            {
              ...
              "@type": "WebSite",
              name: "SwipeCart",
              url: "https://swipecart-app.netlify.app",
              description: "Find your next board game in 60 seconds with swipe-based discovery.",
              potentialAction: {
                "@type": "SearchAction",
                target: "https://swipecart-app.netlify.app/board-games?q={search_term_string}",
