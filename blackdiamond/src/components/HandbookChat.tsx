        ...
        <div className="fixed inset-0 z-[60] bg-card flex flex-col md:inset-auto md:bottom-6 md:right-6 md:w-[400px] md:h-[520px] md:rounded-xl md:border md:border-border md:shadow-2xl">
          ...
          <div className="flex items-center gap-3 px-4 py-3 border-b border-border shrink-0">
            ...
            <button
              ...
              className="w-10 h-10 rounded-lg flex items-center justify-center text-muted-foreground hover:text-foreground shrink-0 -mr-1"
          ...
          >
            ...
            {messages.map((msg, i) => (
              ...
              >
                <div
                  className={`max-w-[85%] rounded-xl px-3.5 py-2.5 text-[15px] leading-relaxed whitespace-pre-wrap ${
                    msg.role === "user"
          ...
          <div
            className="px-3 py-3 border-t border-border shrink-0"
          ...
          >
            ...
            >
              <input
                ...
                className="flex-1 min-w-0 rounded-lg border border-border bg-background px-3 py-3 text-base placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-teal/50 focus:border-teal/30"
              />
              <button
                type="submit"
                disabled={!input.trim() || loading}
                className="w-12 h-12 rounded-lg bg-teal text-white flex items-center justify-center shrink-0 disabled:opacity-40 transition-opacity"
                aria-label="Send"
              >
