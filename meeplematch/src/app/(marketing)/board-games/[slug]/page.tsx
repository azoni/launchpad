...
export async function generateMetadata({
  ...
  if (!product) return { title: "Not Found — MeepleMatch" };
  ...
  return {
    title: `${product.title}`,
    description: `${product.title}: ${playerRange}, ${timeRange}. ${(product.featureBullets as string[])?.[0] ?? "Discover this board game on MeepleMatch."}`,
    alternates: { canonical: `https://meeplematch.netlify.app/board-games/${slug}` },
    openGraph: {
      title: `${product.title} — MeepleMatch`,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([{
            ...
            "@type": "BreadcrumbList",
            itemListElement: [
              { "@type": "ListItem", position: 1, name: "Home", item: "https://meeplematch.netlify.app" },
              { "@type": "ListItem", position: 2, name: "Board Games", item: "https://meeplematch.netlify.app/board-games" },
