...
export const metadata: Metadata = {
  ...
  description: `${APP_NAME} is a public, toggleable calendar profile. Read why I built it.`,
    ...
    <>
      ...
      <main className="flex-1 mx-auto max-w-3xl w-full px-4 py-12 space-y-6">
        ...
        <p className="text-lg text-muted-foreground">
          I built {APP_NAME} because I was running 4+ interviews a day, three side projects,
          and a social life that needed a shared brain. I wanted a cleaner way to say
        ...
        <p>
          Read-only Google Calendar access. Nothing is public unless you flip the toggle. I built
          it as part of the <Link className="underline" href="https://azoni.ai">azoni.ai launchpad</Link>{" "}
          portfolio.
        </p>
